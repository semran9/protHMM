...
You can install the development version of protHMM from [GitHub](https://github.com/) with:
...
A more comperhensive list of functions and the calculations behind the functions can be found [here](https://semran9.github.io/protHMM/articles/protHMM.html).
